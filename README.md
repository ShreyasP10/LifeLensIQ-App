...
Android prototype for the LifeLens IQ project (see `assets/docs/` for PRD/TRD/schema/architecture/ML strategy).
...
├── LifeLensIQApp.kt            Application class (DI init, notification channel)
