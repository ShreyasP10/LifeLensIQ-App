...
import com.lifeiq.app.MainActivity
import com.lifeiq.app.R
 ...
 */
class LifeiqTrackerService : Service() {
    ...
    private fun startTrackingIfNeeded() {
        ...
        appPollJob = scope.launch {
            AppUsagePoller(this@LifeiqTrackerService, emitter).pollLoop()
        }
    ...
    companion object {
        ...
        fun start(context: Context) {
            val intent = Intent(context, LifeiqTrackerService::class.java)
