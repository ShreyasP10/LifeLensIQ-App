...
data class TimetableSlotComparable(
    ...
    fun toSlot(): com.lifeiq.app.domain.model.TimetableSlot = com.lifeiq.app.domain.model.TimetableSlot(
        day = day, slotNo = slotNo, start = start, end = end,
        subject = subject, subjectFull = subjectFull, room = room,
        faculty = "", type = com.lifeiq.app.domain.model.SlotType.from(typeId) ?: com.lifeiq.app.domain.model.SlotType.FREE,
