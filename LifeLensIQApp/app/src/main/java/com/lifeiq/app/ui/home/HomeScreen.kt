...
import com.lifeiq.app.ui.navigation.Routes
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                StatCard("Study", state.studyMinutesToday.toString(), Modifier.weight(1f))
                StatCard("Sessions", state.appSessionsToday.toString(), Modifier.weight(1f))
